...
sudo_users = {363184618,341596458} --put SudoID
  -----------------------------------------------------------------------------------------------
                                     -- start functions --
  -----------------------------------------------------------------------------------------------
...
if database:get('bot:forward:mute'..msg.chat_id_) then
  ...
  return 
	...
	if database:sismember(hash, result.sender_user_id_) then
         send(msg.chat_id_, msg.id_, 1, '_👨🏿‍💻-الشخص_ *'..result.sender_user_id_..'* _بلطبع تم رفعه سابقا 🎩._', 1, 'md')
	else
         database:sadd(hash, result.sender_user_id_)
         send(msg.chat_id_, msg.id_, 1, '● - `👨🏿‍💻-الشخص` *'..result.sender_user_id_..'* `👨🏿‍💻-هذا الحلو تم رفعه ادمن 🌀💛` ☑️', 1, 'md')
	end
    end
	...
	if result.id_ then
            ...
            texts = '<b>User </b><code>'..result.id_..'</code> <b>⚜️-تم رفع هذا الحلو ادمن 🌀💛 .!</b>'
            else 
	...
	local ap = {string.match(text, "^(رفع ادمن) (%d+)$")} 	
         ...
         send(msg.chat_id_, msg.id_, 1, '● - `👨🏿‍💻-الشخص` *'..result.sender_user_id_..'* `👨🏿‍💻-هذا الحلو تم رفعه ادمن 🌀💛` ', 1, 'md')
    end
	-----------------------------------------------------------------------------------------------
	...
	if not database:sismember(hash, result.sender_user_id_) then
         send(msg.chat_id_, msg.id_, 1, '_👨🏿‍💻-الشخص_ *'..result.sender_user_id_..'* _👨🏿‍💻-هو ليس ادمن سابقا 🌀🔻 ._', 1, 'md')
	else
         database:srem(hash, result.sender_user_id_)
         send(msg.chat_id_, msg.id_, 1, '_👨🏿‍💻-الشخص_ *'..result.sender_user_id_..'* _👨🏿‍💻-تم تنزيله من الادمنيه 🌀🔻._', 1, 'md')
	end
    end
	...
	if result.id_ then
         database:srem(hash, result.id_)
            texts = '<b>User </b><code>'..result.id_..'</code> <b>👨🏿‍💻-تم تنزيله من الادمنيه 🌀🔻  🎩</b>'
            else 
            texts = '<code>User not found!</code>'
    end
	         send(msg.chat_id_, msg.id_, 1, texts, 1, 'html')
	...
	send(msg.chat_id_, msg.id_, 1, '_👨🏿‍💻-الشخصr_ *'..ap[2]..'* _👨🏿‍💻-تم تنزيله من الادمنيه 🌀🔻  🎩._', 1, 'md')
    end
	-----------------------------------------------------------------------------------------------
    ...
    if database:sismember(hash, result.sender_user_id_) then
         send(msg.chat_id_, msg.id_, 1, '_👨🏿‍💻-الشخص_ *'..result.sender_user_id_..'* _👨🏿‍💻-تم حظر هذا الشخص ❗️⚠️._', 1, 'md')
		 chat_kick(result.chat_id_, result.sender_user_id_)
	else
         database:sadd(hash, result.sender_user_id_)
         send(msg.chat_id_, msg.id_, 1, '_👨🏿‍💻-الشخصr_ *'..result.sender_user_id_..'* _👨🏿‍💻-تم حظر هذا الشخص ❗️⚠️._', 1, 'md')
		 chat_kick(result.chat_id_, result.sender_user_id_)
	end
    end
	end
	...
	send(msg.chat_id_, msg.id_, 1, '_User_ *'..ap[2]..'* _👨🏿‍💻-لقد تم حظر هذا الشخص ❗️⚠️._', 1, 'md')
	end
    end
	-----------------------------------------------------------------------------------------------
	...
	if is_mod(result.sender_user_id_, result.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, 'لا يمكنك مسح رسائل الادمن او المشرف❗️🔚', 1, 'md')
    else
         send(msg.chat_id_, msg.id_, 1, '👨🏿‍💻-تم تنظيف الكروب 🔻🌀'..result.sender_user_id_..'تم حذفها ❗️ ✅', 1, 'md')
	...
	if is_mod(ass[2], msg.chat_id_) then
         ...
         send(msg.chat_id_, msg.id_, 1, '<b>👨🏿‍💻-تم تنظيف الكروب 🔻🌀</b> <code>'..ass[2]..'</code> <b>تم الحذف !</b>', 1, 'html')
    end
	end
 -----------------------------------------------------------------------------------------------
	...
	if is_mod(result.id_, msg.chat_id_) then
		 ...
		 return false
            ...
            text = '<b>👨🏿‍💻-تم تنظيف الكروب 🔻🌀</b> <code>'..result.id_..'</code> <b>تم حذف!</b>'
            else 
	...
	-----------------------------------------------------------------------------------------------
	if text:match("^(الغاء الحظر)$") and is_mod(msg.sender_user_id_, msg.chat_id_) and msg.reply_to_message_id_ then
	function unban_by_reply(extra, result, success)
	local hash = 'bot:banned:'..msg.chat_id_
	if not database:sismember(hash, result.sender_user_id_) then
         send(msg.chat_id_, msg.id_, 1, '_👨🏿‍💻-👨🏿‍💻-الشخص_ *'..result.sender_user_id_..'* _👨🏿‍💻-هذا الشخص غير محظور او من قائمه المحظورين ❗️🔻  ._', 1, 'md')
	else
         database:srem(hash, result.sender_user_id_)
         send(msg.chat_id_, msg.id_, 1, '_👨🏿‍💻-الشخص_ *'..result.sender_user_id_..'* _👨🏿‍💻-تم الغاء الحظر عنه خلي يحترم نفسه ❗️🔻._', 1, 'md')
	end
    end
	      getMessage(msg.chat_id_, msg.reply_to_message_id_,unban_by_reply)
    end
	-----------------------------------------------------------------------------------------------
	if text:match("^(الغاء الحظر) @(.*)$") and is_mod(msg.sender_user_id_, msg.chat_id_) then
	local ap = {string.match(text, "^(الغاء الحظر) @(.*)$")} 
	function unban_by_username(extra, result, success)
	if result.id_ then
         database:srem('bot:banned:'..msg.chat_id_, result.id_)
            text = '<b>User </b><code>'..result.id_..'</code> <b>👨🏿‍💻-تم الغاء الحظر عنه خلي يحترم نفسه ❗️🔻..!</b>'
            else 
	...
	if is_mod(result.sender_user_id_, result.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_لايمكنك كتم المنشئ او المدير او الادمن ❗️🌀_', 1, 'md')
    else
    if database:sismember(hash, result.sender_user_id_) then
         send(msg.chat_id_, msg.id_, 1, '_👨🏿‍💻-الشخص_ *'..result.sender_user_id_..'* _is Already Muted._', 1, 'md')
	else
         database:sadd(hash, result.sender_user_id_)
         send(msg.chat_id_, msg.id_, 1, '_👨🏿‍💻-الشخص_ *'..result.sender_user_id_..'* _👨🏿‍💻-لقد تم كتم هذا الشخص ❗️🔻._', 1, 'md')
	end
    end
	end
	...
	if result.id_ then
	if is_mod(result.id_, msg.chat_id_) then
         send(msg.chat_id_, msg.id_, 1, '_لايمكنك كتم المدير او المنشئ او الادمن ❗️🔻_', 1, 'md')
    else
	...
	send(msg.chat_id_, msg.id_, 1, '_👨🏿‍💻-الشخص_ *'..ap[2]..'* _Muted._', 1, 'md')
	end
    end
	-----------------------------------------------------------------------------------------------
	...
	local hash = 'bot:muted:'..msg.chat_id_
	if not database:sismember(hash, result.sender_user_id_) then
         send(msg.chat_id_, msg.id_, 1, '_👨🏿‍💻-الشخص_ *'..result.sender_user_id_..'* _is not Muted._', 1, 'md')
	else
         database:srem(hash, result.sender_user_id_)
         send(msg.chat_id_, msg.id_, 1, '_👨🏿‍💻-الشخص_ *'..result.sender_user_id_..'* _Unmuted._', 1, 'md')
	end
    end
	...
	if result.id_ then
         database:srem('bot:muted:'..msg.chat_id_, result.id_)
            text = '<b>👨🏿‍💻-الشخص </b><code>'..result.id_..'</code> <b>👨🏿‍💻-تم فتح الكتم عن هذا الشخص 🌀❗️</b>'
            else 
            text = '<code>هذا الشخص غير موجود ❗️🔍🔻</code>'
    end
	         send(msg.chat_id_, msg.id_, 1, text, 1, 'html')
    end
	...
	send(msg.chat_id_, msg.id_, 1, '_👨🏿‍💻-الشخص_ *'..ap[2]..'* _👨🏿‍💻-تم فتح الكتم عن هذا الشخص 🌀❗️_', 1, 'md')
    end
	-----------------------------------------------------------------------------------------------
	if text:match("^(رفع منشئ)$") and is_admin(msg.sender_user_id_) and msg.reply_to_message_id_ then
	function setowner_by_reply(extra, result, success)
	local hash = 'bot:owners:'..msg.chat_id_
	if database:sismember(hash, result.sender_user_id_) then
         send(msg.chat_id_, msg.id_, 1, '_👨🏿‍💻-الشخص_ *'..result.sender_user_id_..'* _هو منشئ الكروب سابقا 🌀🔻._', 1, 'md')
	else
         database:sadd(hash, result.sender_user_id_)
         send(msg.chat_id_, msg.id_, 1, '_👨🏿‍💻-الشخص_ *'..result.sender_user_id_..'* _تم رفع منشئ الكروب 🔻🌀._', 1, 'md')
	end
    end
	...
	if result.id_ then
            ...
            texts = '<b>👨🏿‍💻-الشخص </b><code>'..result.id_..'</code> <b>👨🏿‍💻-تم رفع منشئ الكروب 🔻🌀.!</b>'
            else 
            texts = '<code>👨🏿‍💻لايمكن ايجاد هذا الشخص 📕🌀 </code>'
    end
	         send(msg.chat_id_, msg.id_, 1, texts, 1, 'html')
    end
	...
	send(msg.chat_id_, msg.id_, 1, '_👨🏿‍💻-الشخص_ *'..ap[2]..'* _👨🏿‍💻-تم رفع منشئ الكروب 🔻🌀._', 1, 'md')
    end
	-----------------------------------------------------------------------------------------------
	if text:match("^تنزيل منشئ$") and is_admin(msg.sender_user_id_) and msg.reply_to_message_id_ then
	function deowner_by_reply(extra, result, success)
	local hash = 'bot:owners:'..msg.chat_id_
	if not database:sismember(hash, result.sender_user_id_) then
         send(msg.chat_id_, msg.id_, 1, '_👨🏿‍💻-الشخص_ *'..result.sender_user_id_..'* _👨🏿‍💻-هو ليس منشئ سابقا ❗️🔻._', 1, 'md')
	else
         database:srem(hash, result.sender_user_id_)
         send(msg.chat_id_, msg.id_, 1, '_👨🏿‍💻-الشخص_ *'..result.sender_user_id_..'* _👨🏿‍💻-تم تنزل منشئ من الكروب ❗️🌀._', 1, 'md')
	end
    end
	      getMessage(msg.chat_id_, msg.reply_to_message_id_,deowner_by_reply)
    end
	-----------------------------------------------------------------------------------------------
	if text:match("^(تنزيل منشئ) @(.*)$") and is_admin(msg.sender_user_id_, msg.chat_id_) then
	local hash = 'bot:owners:'..msg.chat_id_
	local ap = {string.match(text, "^(تنزيل منشئ) @(.*)$")} 
	function remowner_by_username(extra, result, success)
	if result.id_ then
         database:srem(hash, result.id_)
            texts = '<b>User </b><code>'..result.id_..'</code> <b>تم تنزل مدير من الكروب❗️ 👨🏿‍💻</b>'
            else 
	...
	-----------------------------------------------------------------------------------------------
	if text:match("^(تنزيل منشئ) (%d+)$") and is_admin(msg.sender_user_id_, msg.chat_id_) then
	local hash = 'bot:owners:'..msg.chat_id_
	local ap = {string.match(text, "^(تنزيل منشئ) (%d+)$")} 	
         database:srem(hash, ap[2])
	send(msg.chat_id_, msg.id_, 1, '_👨🏿‍💻-الشخص_ *'..ap[2]..'* _👨🏿‍💻-تم تنزل منشئ من الكروب 🔻🌀._', 1, 'md')
    end
	-----------------------------------------------------------------------------------------------
	...
	-----------------------------------------------------------------------------------------------
	if text:match("^المنشئ$") or text:match("^المدراء$") and is_sudo(msg) then
    local hash =  'bot:owners:'..msg.chat_id_
	local list = database:smembers(hash)
   ...
   tdcli_function ({
	...
	local lockpt = {string.match(text, "^(قفل) (.*)$")} 
	  ...
	  if lockpt[2] == "البوتات" then
         send(msg.chat_id_, msg.id_, 1, "_>👨🏿‍💻- تم قفل خاصيه_ *البوتات 🔻❗️*", 1, 'md')
         database:set('bot:bots:mute'..msg.chat_id_,true)
      end
	  if lockpt[2] == "التكرار" then
         send(msg.chat_id_, msg.id_, 1, '*👨🏿‍💻-تم قفل خاصيه التكرار 🌀❗️*', 1, 'md')
         database:del('anti-flood:'..msg.chat_id_)
	  end
	  if lockpt[2] == "التثبيت" then
         send(msg.chat_id_, msg.id_, 1, "*تم قفل خاصيه التثبيت 📝🔻*", 1, 'md')
...
.."*صلاحية المجموعه* : "..exp_dat.."\n" .."*القناة* : @vps_no"
	...
	-----------------------------------------------------------------------------------------------
  	if text:match("^المطور$") and is_sudo(msg) then
       sendContact(msg.chat_id_, msg.id_, 0, 1, nil, 9647713062016, 'سعدون ال مشايخ >بيكاجو', '(Test Version..!)', bot_id)
    end
	-----------------------------------------------------------------------------------------------
...
if text:match('تفعيل') and is_admin(msg.sender_user_id_, msg.chat_id_) then
  ...
  if text:match('^تعطيل') and is_admin(msg.sender_user_id_, msg.chat_id_) then
	   ...
	   send(msg.chat_id_, msg.id_, 1, ' *تم*\nطبكم مرض لو يجي الله بعد مافعل 😹❌!', 1, 'md')
	   for k,v in pairs(sudo_users) do
	      send(v, 0, 1, "*User"..msg.sender_user_id_.." طبكم مرض لو يجي الله بعد مافعل 😹❌*" , 1, 'md')
       end
  end
	-----------------------------------------------------------------------------------------------
   if text:match("^ايدي") then
   ...
   if text:match("^الغاء تثبيت$") and is_owner(msg.sender_user_id_, msg.chat_id_) then
         unpinmsg(msg.chat_id_)
         send(msg.chat_id_, msg.id_, 1, 'تم الغاء تثبيت ❗️🔻!', 1, 'md')
   end
   -----------------------------------------------------------------------------------------------
...
local pin_id = database:get('pinnedmsg'..msg.chat_id_)
        if pin_id then
         pin(msg.chat_id_,pin_id,0)
         send(msg.chat_id_, msg.id_, 1, '*تم اعاده تثبيت الرساله السابقه 📒✏️!*', 1, 'md')
		else
...
📌- الغاء التثبيت +بالرد 
📌-اعاده التثبيت + بالرد
📍-ايدي + بالرد لعرض ايدي الشخص الرقمي 
📍-ايدي لعرض معلوماتك !
...
🎐  ضع اسم + الكلمه              
🎐 المده شهر 1 + المده شهرين 2 + المده مفتوحه 1 ,,,,, لاعطاء مده للكروب
🎐 ضع قوانين + النص 
🎐 كرر + الكلمه ليردد ماتكتب 
🎐 اضافه + بلرد على العضو ليضيفه اللا الكروب
🎐 طرد + بلرد
🎐 تشغيل لتفعيل المجموعه + تعطيل لتعطيل المجموعه
