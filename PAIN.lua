...
.."*صلاحية المجموعه* : "..exp_dat.."\n" .."*القناة* : @vps_no"
	...
	-----------------------------------------------------------------------------------------------
  	if text:match("^المطور$") and is_sudo(msg) then
       sendContact(msg.chat_id_, msg.id_, 0, 1, nil, 9647807862905, 'ابوطبر', '(Test Version..!)', bot_id)
    end
	-----------------------------------------------------------------------------------------------
...
🎩 رفع ادمن + بلرد  او تنزيل ادمن + بلرد 

🎩 رفع مدير +بلرد او تنزيل مدير + بلرد 

🎩 الادمنيه لعرض قائمه الادمنيه 

🎩 حظر + بلرد  او الغاء حظر + بلرد 

🎩 كتم + بلرد او الغاء الكتم + بلرد 

🎩 تثبيت + بلرد + الغاء تثبيت + اعاده تثبيت 

🎩 ايدي لعرض موقعك + ايدي بلرد على العضو لعرض ايدي العضو 
...
🎩 التوجيه | المتحركه | الدردشه | الصوتيات | التعديل | المعرف | الانكليزية 

🎩 الاغاني | الملصقات | الروابط |الفيديو | الصور | البوتات | الشبكات | العربية
...
ملاحضه : السورس بس عربي  الشغلات الي ماله داعي حذفته سورس سريع جدا يشتغل على c9.io مينحظر  خالي من الحقوق!!*
]]
